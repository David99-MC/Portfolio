  ...
  return (
    <div className="relative">
      ...
      <div className="border-solid grid grid-cols-2 border-black border-b-2 border-l-2 ">
        ...
        <div className="bg-pastel-blue col-span-2 lg:col-span-1 border-solid border-black border-b-2 border-r-2">
          <img
        ...
        <div className="col-span-2 lg:col-span-1 border-solid border-black border-r-2">
          <div className="px-10 py-24 lg:px-20 lg:py-48 space-y-7">
            <WorkRelevant>latest work</WorkRelevant>
            <h1 className="lg:text-5xl font-extrabold font-display w-full text-5xl tracking-tight">
              The Lam's Bakery
        ...
        <div className="bg-pastel-pink col-span-2 lg:col-span-1 border-solid border-black border-r-2">
          <img
